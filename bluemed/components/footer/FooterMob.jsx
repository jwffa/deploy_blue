...
const FooterMob = () => {
  return (
    <div className='m-auto md:hidden'>
        ...
        {({ open }) => (
          <>
            <DisclosureButton className="group flex w-full items-center justify-between mb-6">
              <span className="text-sm/6 font-medium text-[#0b2849] group-data-[hover]:text-[#0b2849]/80">
                ექიმის სივრცე
              </span>
              <ChevronDown
                color="#0b2849"
            ...
            <Transition
              ...
              >
              <DisclosurePanel className="mt-2 text-sm/5 text-[#0b2849]/50 flex flex-col items-start gap-4">
      ...
      <Disclosure as="div" className="px-12 mt-7">
        {({ open }) => (
          <>
            <DisclosureButton className="group flex w-full items-center justify-between mb-6">
              <span className="text-sm/6 font-medium text-[#0b2849] group-data-[hover]:text-[#0b2849]/80">
